...
class XLSSplitter(QWidget):
    ...
    def initUI(self):
        ...
        self.COMBOBOX_TARGET_COLUMNS.setToolTip("拆分依据")
        ...
        self.LINEEDIT_TARGET_PATH.setPlaceholderText("目标路径")
